    ...
    <div class="container fluid">
        <div class="row py-4">
            <div class="col-lg-4 mb-4">
                <div class="card" id="bg-color-body-card">
    ...
    <div class="container fluid">
        <div class="row py-4">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card" id="bg-color-body-card">
                    <img src="/public/assets/img/test-creation-stuff-1.png" class="card-img-top img-fluid" alt="création-utilisateur-1">
                    <div class="card-body p-0">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card" id="bg-color-body-card">
                    <img src="/public/assets/img/test-creation-stuff-2.png" class="card-img-top img-fluid" alt="création-utilisateur-2">
                    <div class="card-body p-0">
